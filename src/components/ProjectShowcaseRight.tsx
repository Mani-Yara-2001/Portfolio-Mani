...
>(({ className, children, bgColor }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
    ...
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref} bgColor={data?.[6]?.bgColor}>
            {data?.[6]?.icon}
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16" bgColor={data?.[5]?.bgColor}>
            {data?.[5]?.icon}
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref} bgColor={data?.[0]?.bgColor}>
            {data?.[0]?.icon}
          </Circle>
          <Circle ref={div2Ref} bgColor={data?.[1]?.bgColor}>
            {data?.[1]?.icon}
          </Circle>
          <Circle ref={div3Ref} bgColor={data?.[2]?.bgColor}>
            {data?.[2]?.icon}
          </Circle>
          <Circle ref={div4Ref} bgColor={data?.[3]?.bgColor}>
            {data?.[3]?.icon}
          </Circle>
          <Circle ref={div5Ref} bgColor={data?.[4]?.bgColor}>
            {data?.[4]?.icon}
          </Circle>
        </div>
      </div>
